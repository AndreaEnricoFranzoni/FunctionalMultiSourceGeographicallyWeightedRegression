...
#'                         }
#'                   \item 'Beta_e': **`list`** containing, for each station-dependent covariate regression coefficient (each element is named with the element names in the list coeff_stations_cov (default, if not given: **`"CovS*"`**)) a list with:
#'                         \itemize{
#'                         \item 'Beta_eval': **`list`**, containing, for each statistical unit, a **`numeric vector`** of double containing the discrete evaluations of the non-stationary beta, one for each unit.
#'                         \item 'Abscissa': **`numeric vector`** of double containing the domain points for which the evaluation of the beta is available (it is the input t_points).
#'                         }
...
#'                                     \item 'knots': knots used to make the basis expansion of the functional regression coefficients of the stationary covariates (element knots_beta_stationary_cov).
#'                                     }
#'                               \item 'cov_Event': **`list`**:
#'                                     \itemize{
...
#'                                     \item 'knots': knots used to make the basis expansion of the functional regression coefficients of the event-dependent covariates (element knots_beta_events_cov).
#'                                     }
...
#'                                     \item 'knots': knots used to make the basis expansion of the functional regression coefficients of the station-dependent covariates (element knots_beta_stations_cov).
#'                                     }
#'                               }
...
#'         \item 'EstimationTechnique': **`string`**: **`"Exact"`** if *in_cascade_estimation* model_fitted false, **`"Cascade"`** if *in_cascade_estimation* model_fitted true.
...
#'               \item 'basis_type': type of basis used for the beta basis expansion (from model_fitted).
#'               \item 'knots': knots used for the beta basis expansion (from model_fitted).
#'               }
