...
// fmsgwr
Rcpp::List fmsgwr(Rcpp::NumericMatrix y_points, Rcpp::NumericMatrix coeff_y_points, Rcpp::NumericVector knots_y_points, Rcpp::Nullable<int> n_order_basis_y_points, Rcpp::Nullable<int> n_basis_y_points, double penalization_y_points, Rcpp::NumericMatrix coeff_rec_weights_y_points, Rcpp::Nullable<int> n_order_basis_rec_weights_y_points, Rcpp::Nullable<int> n_basis_rec_weights_y_points, Rcpp::NumericVector t_points, double left_extreme_domain, double right_extreme_domain, Rcpp::List coeff_stationary_cov, Rcpp::NumericVector knots_stationary_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_order_basis_stationary_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_basis_stationary_cov, Rcpp::NumericVector penalization_stationary_cov, Rcpp::List coeff_rec_weights_stationary_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_order_basis_rec_weights_stationary_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_basis_rec_weights_stationary_cov, Rcpp::List coeff_events_cov, Rcpp::NumericVector knots_events_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_order_basis_events_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_basis_events_cov, Rcpp::NumericVector penalization_events_cov, Rcpp::List coeff_rec_weights_events_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_order_basis_rec_weights_events_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_basis_rec_weights_events_cov, Rcpp::NumericMatrix distances_events, double bandwith_events, Rcpp::List coeff_stations_cov, Rcpp::NumericVector knots_stations_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_order_basis_stations_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_basis_stations_cov, Rcpp::NumericVector penalization_stations_cov, Rcpp::List coeff_rec_weights_stations_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_order_basis_rec_weights_stations_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_basis_rec_weights_stations_cov, Rcpp::NumericMatrix distances_stations, double bandwith_stations, Rcpp::Nullable<int> num_threads);
RcppExport SEXP _fdagwr_fmsgwr(SEXP y_pointsSEXP, SEXP coeff_y_pointsSEXP, SEXP knots_y_pointsSEXP, SEXP n_order_basis_y_pointsSEXP, SEXP n_basis_y_pointsSEXP, SEXP penalization_y_pointsSEXP, SEXP coeff_rec_weights_y_pointsSEXP, SEXP n_order_basis_rec_weights_y_pointsSEXP, SEXP n_basis_rec_weights_y_pointsSEXP, SEXP t_pointsSEXP, SEXP left_extreme_domainSEXP, SEXP right_extreme_domainSEXP, SEXP coeff_stationary_covSEXP, SEXP knots_stationary_covSEXP, SEXP n_order_basis_stationary_covSEXP, SEXP n_basis_stationary_covSEXP, SEXP penalization_stationary_covSEXP, SEXP coeff_rec_weights_stationary_covSEXP, SEXP n_order_basis_rec_weights_stationary_covSEXP, SEXP n_basis_rec_weights_stationary_covSEXP, SEXP coeff_events_covSEXP, SEXP knots_events_covSEXP, SEXP n_order_basis_events_covSEXP, SEXP n_basis_events_covSEXP, SEXP penalization_events_covSEXP, SEXP coeff_rec_weights_events_covSEXP, SEXP n_order_basis_rec_weights_events_covSEXP, SEXP n_basis_rec_weights_events_covSEXP, SEXP distances_eventsSEXP, SEXP bandwith_eventsSEXP, SEXP coeff_stations_covSEXP, SEXP knots_stations_covSEXP, SEXP n_order_basis_stations_covSEXP, SEXP n_basis_stations_covSEXP, SEXP penalization_stations_covSEXP, SEXP coeff_rec_weights_stations_covSEXP, SEXP n_order_basis_rec_weights_stations_covSEXP, SEXP n_basis_rec_weights_stations_covSEXP, SEXP distances_stationsSEXP, SEXP bandwith_stationsSEXP, SEXP num_threadsSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::List >::type coeff_rec_weights_stationary_cov(coeff_rec_weights_stationary_covSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::IntegerVector> >::type n_order_basis_rec_weights_stationary_cov(n_order_basis_rec_weights_stationary_covSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::IntegerVector> >::type n_basis_rec_weights_stationary_cov(n_basis_rec_weights_stationary_covSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::List >::type coeff_rec_weights_events_cov(coeff_rec_weights_events_covSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::IntegerVector> >::type n_order_basis_rec_weights_events_cov(n_order_basis_rec_weights_events_covSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::IntegerVector> >::type n_basis_rec_weights_events_cov(n_basis_rec_weights_events_covSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::List >::type coeff_rec_weights_stations_cov(coeff_rec_weights_stations_covSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::IntegerVector> >::type n_order_basis_rec_weights_stations_cov(n_order_basis_rec_weights_stations_covSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::IntegerVector> >::type n_basis_rec_weights_stations_cov(n_basis_rec_weights_stations_covSEXP);
