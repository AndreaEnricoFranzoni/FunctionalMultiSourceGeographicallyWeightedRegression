...
// fdagwr_testing
void fdagwr_testing();
RcppExport SEXP _fdagwr_fdagwr_testing() {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    fdagwr_testing();
    return R_NilValue;
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(FMGWR(y_points, t_points, left_extreme_domain, right_extreme_domain, coeff_y_points, knots_y_points, degree_basis_y_points, n_basis_y_points, coeff_rec_weights_y_points, degree_basis_rec_weights_y_points, n_basis_rec_weights_y_points, coeff_stationary_cov, basis_types_stationary_cov, knots_stationary_cov, degrees_basis_stationary_cov, n_basis_stationary_cov, penalization_stationary_cov, knots_beta_stationary_cov, degrees_basis_beta_stationary_cov, n_basis_beta_stationary_cov, coeff_non_stationary_cov, basis_types_non_stationary_cov, knots_non_stationary_cov, degrees_basis_non_stationary_cov, n_basis_non_stationary_cov, penalization_non_stationary_cov, coordinates_non_stationary, kernel_bandwith_non_stationary, knots_beta_non_stationary_cov, degrees_basis_beta_non_stationary_cov, n_basis_beta_non_stationary_cov, bf_estimation, n_knots_smoothing, n_intervals_trapezoidal_quadrature, target_error_trapezoidal_quadrature, max_iterations_trapezoidal_quadrature, num_threads, basis_type_y_points, basis_type_rec_weights_y_points, basis_types_beta_stationary_cov, basis_types_beta_non_stationary_cov));
    return rcpp_result_gen;
END_RCPP
}
// predict_FMGWR
Rcpp::List predict_FMGWR(Rcpp::List coeff_stationary_cov_to_pred, Rcpp::List coeff_non_stationary_cov_to_pred, Rcpp::NumericMatrix coordinates_non_stationary_to_pred, int units_to_be_predicted, Rcpp::NumericVector abscissa_ev, Rcpp::List model_fitted, int n_knots_smoothing_pred, int n_intervals_trapezoidal_quadrature, double target_error_trapezoidal_quadrature, int max_iterations_trapezoidal_quadrature, Rcpp::Nullable<int> num_threads);
RcppExport SEXP _fdagwr_predict_FMGWR(SEXP coeff_stationary_cov_to_predSEXP, SEXP coeff_non_stationary_cov_to_predSEXP, SEXP coordinates_non_stationary_to_predSEXP, SEXP units_to_be_predictedSEXP, SEXP abscissa_evSEXP, SEXP model_fittedSEXP, SEXP n_knots_smoothing_predSEXP, SEXP n_intervals_trapezoidal_quadratureSEXP, SEXP target_error_trapezoidal_quadratureSEXP, SEXP max_iterations_trapezoidal_quadratureSEXP, SEXP num_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type coeff_stationary_cov_to_pred(coeff_stationary_cov_to_predSEXP);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::CharacterVector> >::type basis_types_beta_stationary_cov(basis_types_beta_stationary_covSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::CharacterVector> >::type basis_types_beta_non_stationary_cov(basis_types_beta_non_stationary_covSEXP);
    rcpp_result_gen = Rcpp::wrap(FGWR(y_points, t_points, left_extreme_domain, right_extreme_domain, coeff_y_points, knots_y_points, degree_basis_y_points, n_basis_y_points, coeff_rec_weights_y_points, degree_basis_rec_weights_y_points, n_basis_rec_weights_y_points, coeff_non_stationary_cov, basis_types_non_stationary_cov, knots_non_stationary_cov, degrees_basis_non_stationary_cov, n_basis_non_stationary_cov, penalization_non_stationary_cov, coordinates_non_stationary, kernel_bandwith_non_stationary, knots_beta_non_stationary_cov, degrees_basis_beta_non_stationary_cov, n_basis_beta_non_stationary_cov, n_intervals_trapezoidal_quadrature, target_error_trapezoidal_quadrature, max_iterations_trapezoidal_quadrature, num_threads, basis_type_y_points, basis_type_rec_weights_y_points, basis_types_beta_stationary_cov, basis_types_beta_non_stationary_cov));
    return rcpp_result_gen;
END_RCPP
}
// predict_FGWR
Rcpp::List predict_FGWR(Rcpp::List coeff_non_stationary_cov_to_pred, Rcpp::NumericMatrix coordinates_non_stationary_to_pred, int units_to_be_predicted, Rcpp::NumericVector abscissa_ev, Rcpp::List model_fitted, int n_knots_smoothing_pred, int n_intervals_trapezoidal_quadrature, double target_error_trapezoidal_quadrature, int max_iterations_trapezoidal_quadrature, Rcpp::Nullable<int> num_threads);
RcppExport SEXP _fdagwr_predict_FGWR(SEXP coeff_non_stationary_cov_to_predSEXP, SEXP coordinates_non_stationary_to_predSEXP, SEXP units_to_be_predictedSEXP, SEXP abscissa_evSEXP, SEXP model_fittedSEXP, SEXP n_knots_smoothing_predSEXP, SEXP n_intervals_trapezoidal_quadratureSEXP, SEXP target_error_trapezoidal_quadratureSEXP, SEXP max_iterations_trapezoidal_quadratureSEXP, SEXP num_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type coeff_non_stationary_cov_to_pred(coeff_non_stationary_cov_to_predSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type max_iterations_trapezoidal_quadrature(max_iterations_trapezoidal_quadratureSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<int> >::type num_threads(num_threadsSEXP);
    rcpp_result_gen = Rcpp::wrap(predict_FGWR(coeff_non_stationary_cov_to_pred, coordinates_non_stationary_to_pred, units_to_be_predicted, abscissa_ev, model_fitted, n_knots_smoothing_pred, n_intervals_trapezoidal_quadrature, target_error_trapezoidal_quadrature, max_iterations_trapezoidal_quadrature, num_threads));
    return rcpp_result_gen;
END_RCPP
}
// FWR
Rcpp::List FWR(Rcpp::NumericMatrix y_points, Rcpp::NumericVector t_points, double left_extreme_domain, double right_extreme_domain, Rcpp::NumericMatrix coeff_y_points, Rcpp::NumericVector knots_y_points, Rcpp::Nullable<int> degree_basis_y_points, Rcpp::Nullable<int> n_basis_y_points, Rcpp::NumericMatrix coeff_rec_weights_y_points, Rcpp::Nullable<int> degree_basis_rec_weights_y_points, Rcpp::Nullable<int> n_basis_rec_weights_y_points, Rcpp::List coeff_stationary_cov, Rcpp::Nullable<Rcpp::CharacterVector> basis_types_stationary_cov, Rcpp::NumericVector knots_stationary_cov, Rcpp::Nullable<Rcpp::IntegerVector> degrees_basis_stationary_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_basis_stationary_cov, Rcpp::NumericVector penalization_stationary_cov, Rcpp::NumericVector knots_beta_stationary_cov, Rcpp::Nullable<Rcpp::IntegerVector> degrees_basis_beta_stationary_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_basis_beta_stationary_cov, int n_intervals_trapezoidal_quadrature, double target_error_trapezoidal_quadrature, int max_iterations_trapezoidal_quadrature, Rcpp::Nullable<int> num_threads, std::string basis_type_y_points, std::string basis_type_rec_weights_y_points, Rcpp::Nullable<Rcpp::CharacterVector> basis_types_beta_stationary_cov);
RcppExport SEXP _fdagwr_FWR(SEXP y_pointsSEXP, SEXP t_pointsSEXP, SEXP left_extreme_domainSEXP, SEXP right_extreme_domainSEXP, SEXP coeff_y_pointsSEXP, SEXP knots_y_pointsSEXP, SEXP degree_basis_y_pointsSEXP, SEXP n_basis_y_pointsSEXP, SEXP coeff_rec_weights_y_pointsSEXP, SEXP degree_basis_rec_weights_y_pointsSEXP, SEXP n_basis_rec_weights_y_pointsSEXP, SEXP coeff_stationary_covSEXP, SEXP basis_types_stationary_covSEXP, SEXP knots_stationary_covSEXP, SEXP degrees_basis_stationary_covSEXP, SEXP n_basis_stationary_covSEXP, SEXP penalization_stationary_covSEXP, SEXP knots_beta_stationary_covSEXP, SEXP degrees_basis_beta_stationary_covSEXP, SEXP n_basis_beta_stationary_covSEXP, SEXP n_intervals_trapezoidal_quadratureSEXP, SEXP target_error_trapezoidal_quadratureSEXP, SEXP max_iterations_trapezoidal_quadratureSEXP, SEXP num_threadsSEXP, SEXP basis_type_y_pointsSEXP, SEXP basis_type_rec_weights_y_pointsSEXP, SEXP basis_types_beta_stationary_covSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type y_points(y_pointsSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_fdagwr_fdagwr_testing", (DL_FUNC) &_fdagwr_fdagwr_testing, 0},
    {"_fdagwr_FMSGWR_ESC", (DL_FUNC) &_fdagwr_FMSGWR_ESC, 53},
    {"_fdagwr_predict_FMSGWR_ESC", (DL_FUNC) &_fdagwr_predict_FMSGWR_ESC, 13},
    {"_fdagwr_FMSGWR_SEC", (DL_FUNC) &_fdagwr_FMSGWR_SEC, 53},
    {"_fdagwr_predict_FMSGWR_SEC", (DL_FUNC) &_fdagwr_predict_FMSGWR_SEC, 13},
    {"_fdagwr_FMGWR", (DL_FUNC) &_fdagwr_FMGWR, 41},
    {"_fdagwr_predict_FMGWR", (DL_FUNC) &_fdagwr_predict_FMGWR, 11},
    {"_fdagwr_FGWR", (DL_FUNC) &_fdagwr_FGWR, 30},
    {"_fdagwr_predict_FGWR", (DL_FUNC) &_fdagwr_predict_FGWR, 10},
    {"_fdagwr_FWR", (DL_FUNC) &_fdagwr_FWR, 27},
