...
// fmsgwr
Rcpp::List fmsgwr(Rcpp::NumericMatrix y_points, Rcpp::NumericVector t_points, double left_extreme_domain, double right_extreme_domain, Rcpp::NumericMatrix coeff_y_points, Rcpp::NumericVector knots_y_points, Rcpp::Nullable<int> n_order_basis_y_points, Rcpp::Nullable<int> n_basis_y_points, Rcpp::NumericMatrix coeff_rec_weights_y_points, Rcpp::Nullable<int> n_order_basis_rec_weights_y_points, Rcpp::Nullable<int> n_basis_rec_weights_y_points, Rcpp::List coeff_stationary_cov, Rcpp::CharacterVector basis_types_stationary_cov, Rcpp::NumericVector knots_stationary_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_order_basis_stationary_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_basis_stationary_cov, Rcpp::NumericVector penalization_stationary_cov, Rcpp::NumericVector knots_beta_stationary_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_order_basis_beta_stationary_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_basis_beta_stationary_cov, Rcpp::List coeff_events_cov, Rcpp::CharacterVector basis_types_events_cov, Rcpp::NumericVector knots_events_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_order_basis_events_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_basis_events_cov, Rcpp::NumericVector penalization_events_cov, Rcpp::NumericMatrix coordinates_events, double bandwith_events, Rcpp::NumericVector knots_beta_events_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_order_basis_beta_events_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_basis_beta_events_cov, Rcpp::List coeff_stations_cov, Rcpp::CharacterVector basis_types_stations_cov, Rcpp::NumericVector knots_stations_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_order_basis_stations_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_basis_stations_cov, Rcpp::NumericVector penalization_stations_cov, Rcpp::NumericMatrix coordinates_stations, double bandwith_stations, Rcpp::NumericVector knots_beta_stations_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_order_basis_beta_stations_cov, Rcpp::Nullable<Rcpp::IntegerVector> n_basis_beta_stations_cov, Rcpp::Nullable<int> num_threads);
RcppExport SEXP _fdagwr_fmsgwr(SEXP y_pointsSEXP, SEXP t_pointsSEXP, SEXP left_extreme_domainSEXP, SEXP right_extreme_domainSEXP, SEXP coeff_y_pointsSEXP, SEXP knots_y_pointsSEXP, SEXP n_order_basis_y_pointsSEXP, SEXP n_basis_y_pointsSEXP, SEXP coeff_rec_weights_y_pointsSEXP, SEXP n_order_basis_rec_weights_y_pointsSEXP, SEXP n_basis_rec_weights_y_pointsSEXP, SEXP coeff_stationary_covSEXP, SEXP basis_types_stationary_covSEXP, SEXP knots_stationary_covSEXP, SEXP n_order_basis_stationary_covSEXP, SEXP n_basis_stationary_covSEXP, SEXP penalization_stationary_covSEXP, SEXP knots_beta_stationary_covSEXP, SEXP n_order_basis_beta_stationary_covSEXP, SEXP n_basis_beta_stationary_covSEXP, SEXP coeff_events_covSEXP, SEXP basis_types_events_covSEXP, SEXP knots_events_covSEXP, SEXP n_order_basis_events_covSEXP, SEXP n_basis_events_covSEXP, SEXP penalization_events_covSEXP, SEXP coordinates_eventsSEXP, SEXP bandwith_eventsSEXP, SEXP knots_beta_events_covSEXP, SEXP n_order_basis_beta_events_covSEXP, SEXP n_basis_beta_events_covSEXP, SEXP coeff_stations_covSEXP, SEXP basis_types_stations_covSEXP, SEXP knots_stations_covSEXP, SEXP n_order_basis_stations_covSEXP, SEXP n_basis_stations_covSEXP, SEXP penalization_stations_covSEXP, SEXP coordinates_stationsSEXP, SEXP bandwith_stationsSEXP, SEXP knots_beta_stations_covSEXP, SEXP n_order_basis_beta_stations_covSEXP, SEXP n_basis_beta_stations_covSEXP, SEXP num_threadsSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::CharacterVector >::type basis_types_stationary_cov(basis_types_stationary_covSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::CharacterVector >::type basis_types_events_cov(basis_types_events_covSEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::CharacterVector >::type basis_types_stations_cov(basis_types_stations_covSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(fmsgwr(y_points, t_points, left_extreme_domain, right_extreme_domain, coeff_y_points, knots_y_points, n_order_basis_y_points, n_basis_y_points, coeff_rec_weights_y_points, n_order_basis_rec_weights_y_points, n_basis_rec_weights_y_points, coeff_stationary_cov, basis_types_stationary_cov, knots_stationary_cov, n_order_basis_stationary_cov, n_basis_stationary_cov, penalization_stationary_cov, knots_beta_stationary_cov, n_order_basis_beta_stationary_cov, n_basis_beta_stationary_cov, coeff_events_cov, basis_types_events_cov, knots_events_cov, n_order_basis_events_cov, n_basis_events_cov, penalization_events_cov, coordinates_events, bandwith_events, knots_beta_events_cov, n_order_basis_beta_events_cov, n_basis_beta_events_cov, coeff_stations_cov, basis_types_stations_cov, knots_stations_cov, n_order_basis_stations_cov, n_basis_stations_cov, penalization_stations_cov, coordinates_stations, bandwith_stations, knots_beta_stations_cov, n_order_basis_beta_stations_cov, n_basis_beta_stations_cov, num_threads));
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_fdagwr_fmsgwr", (DL_FUNC) &_fdagwr_fmsgwr, 43},
