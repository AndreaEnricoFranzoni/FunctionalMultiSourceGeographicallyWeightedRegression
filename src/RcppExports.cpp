...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(FSGWR(y_points, t_points, left_extreme_domain, right_extreme_domain, coeff_y_points, knots_y_points, degree_basis_y_points, n_basis_y_points, coeff_rec_weights_y_points, degree_basis_rec_weights_y_points, n_basis_rec_weights_y_points, coeff_stationary_cov, basis_types_stationary_cov, knots_stationary_cov, degrees_basis_stationary_cov, n_basis_stationary_cov, penalization_stationary_cov, knots_beta_stationary_cov, degrees_basis_beta_stationary_cov, n_basis_beta_stationary_cov, coeff_non_stationary_cov, basis_types_non_stationary_cov, knots_non_stationary_cov, degrees_basis_non_stationary_cov, n_basis_non_stationary_cov, penalization_non_stationary_cov, coordinates_non_stationary, kernel_bandwith_non_stationary, knots_beta_non_stationary_cov, degrees_basis_beta_non_stationary_cov, n_basis_beta_non_stationary_cov, n_knots_smoothing, n_intervals_trapezoidal_quadrature, target_error_trapezoidal_quadrature, max_iterations_trapezoidal_quadrature, num_threads, basis_type_y_points, basis_type_rec_weights_y_points, basis_types_beta_stationary_cov, basis_types_beta_non_stationary_cov));
    return rcpp_result_gen;
END_RCPP
}
// predict_FSGWR
Rcpp::List predict_FSGWR(Rcpp::List coeff_stationary_cov_to_pred, Rcpp::List coeff_non_stationary_cov_to_pred, Rcpp::NumericMatrix coordinates_non_stationary_to_pred, int units_to_be_predicted, Rcpp::NumericVector abscissa_ev, Rcpp::List model_fitted, int n_intervals_trapezoidal_quadrature, double target_error_trapezoidal_quadrature, int max_iterations_trapezoidal_quadrature, Rcpp::Nullable<int> num_threads);
RcppExport SEXP _fdagwr_predict_FSGWR(SEXP coeff_stationary_cov_to_predSEXP, SEXP coeff_non_stationary_cov_to_predSEXP, SEXP coordinates_non_stationary_to_predSEXP, SEXP units_to_be_predictedSEXP, SEXP abscissa_evSEXP, SEXP model_fittedSEXP, SEXP n_intervals_trapezoidal_quadratureSEXP, SEXP target_error_trapezoidal_quadratureSEXP, SEXP max_iterations_trapezoidal_quadratureSEXP, SEXP num_threadsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type coeff_stationary_cov_to_pred(coeff_stationary_cov_to_predSEXP);
